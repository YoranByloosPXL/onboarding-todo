...
export const getTodosControllerGetTodosV1 = <ThrowOnError extends boolean = true>(options?: Options<GetTodosControllerGetTodosV1Data, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetTodosControllerGetTodosV1Response, unknown, ThrowOnError>({
        responseValidator: async (data) => {
            return await zGetTodosControllerGetTodosV1Response.parseAsync(data);
        },
        url: '/api/v1/todos',
        ...options
    });
...
export const createTodoControllerCreateTodoV1 = <ThrowOnError extends boolean = true>(options: Options<CreateTodoControllerCreateTodoV1Data, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<CreateTodoControllerCreateTodoV1Response, unknown, ThrowOnError>({
        responseValidator: async (data) => {
            return await zCreateTodoControllerCreateTodoV1Response.parseAsync(data);
        },
        url: '/api/v1/todos',
        ...options,
        headers: {
...
export const deleteTodoControllerDeleteTodoV1 = <ThrowOnError extends boolean = true>(options: Options<DeleteTodoControllerDeleteTodoV1Data, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<unknown, unknown, ThrowOnError>({
...
export const getTodosControllerGetTodoV1 = <ThrowOnError extends boolean = true>(options: Options<GetTodosControllerGetTodoV1Data, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetTodosControllerGetTodoV1Response, GetTodosControllerGetTodoV1Error, ThrowOnError>({
        responseValidator: async (data) => {
            return await zGetTodosControllerGetTodoV1Response.parseAsync(data);
        },
        url: '/api/v1/todos/{todoUuid}',
        ...options
    });
...
export const updateTodoControllerUpdateTodoV1 = <ThrowOnError extends boolean = true>(options: Options<UpdateTodoControllerUpdateTodoV1Data, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<unknown, unknown, ThrowOnError>({
        url: '/api/v1/todos/{todoUuid}',
        ...options,
        headers: {
...
export const checkTodoControllerCheckTodoV1 = <ThrowOnError extends boolean = true>(options: Options<CheckTodoControllerCheckTodoV1Data, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<unknown, unknown, ThrowOnError>({
...
export const uncheckTodoControllerUncheckTodoV1 = <ThrowOnError extends boolean = true>(options: Options<UncheckTodoControllerUncheckTodoV1Data, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<unknown, unknown, ThrowOnError>({
